...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add Product ".concat(p.name, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductStore.prototype.update = function (id, name, price) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, result, conn, updatedProduct, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 9, , 10]);
                    ...
                    case 1:
                        ...
                        if (!(name &&
                            typeof name === "string" &&
                            price &&
                            typeof price === "number")) return [3 /*break*/, 3];
                        sql = "UPDATE products SET name=$1, price=$2 WHERE id=$3 RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [name, price, id])];
                    case 2:
                        result = _a.sent();
                        return [3 /*break*/, 8];
                    case 3:
                        if (!(name && typeof name === "string")) return [3 /*break*/, 5];
                        sql = "UPDATE products SET name=$1 WHERE id=$2 RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [name, id])];
                    case 4:
                        result = _a.sent();
                        return [3 /*break*/, 8];
                    case 5:
                        if (!(price && typeof price === "number")) return [3 /*break*/, 7];
                        sql = "UPDATE products SET  price=$1 WHERE id=$2 RETURNING *";
                        return [4 /*yield*/, conn.query(sql, [price, id])];
                    case 6:
                        result = _a.sent();
                        return [3 /*break*/, 8];
                    ...
                    case 9:
                        err_5 = _a.sent();
                        throw new Error("Could not update Product ".concat(id, ". Error: ").concat(err_5));

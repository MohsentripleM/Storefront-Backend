    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!Product.price) return [3 /*break*/, 2];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, name_1, price, updatedProduct, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = parseInt(req.params.id);
            ...
            case 1:
                ...
                if (!price) return [3 /*break*/, 3];
                return [4 /*yield*/, store.update(id, name_1, price)];
            case 2:
...
var productRoutes = function (app) {
    ...
    app.post("/products", permitUser_1.default, permitAdmin_1.default, create);
    app.delete("/products/:id", permitUser_1.default, permitAdmin_1.default, destroy);
    app.patch("/products/:id", permitUser_1.default, permitAdmin_1.default, update);
};
